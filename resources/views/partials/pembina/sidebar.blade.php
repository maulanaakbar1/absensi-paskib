<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
    ...
    <nav class="flex-1 px-4 space-y-2">
        ...
        <a href="{{ route('pembina.riwayat.index') }}" 
            class="flex items-center gap-3 {{ Request::is('pembina/riwayat-absensi*') ? 'bg-blue-50 text-blue-600' : 'text-slate-500 hover:bg-slate-50' }} px-4 py-3 rounded-xl font-semibold transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
